...
export default class Particles {
  ...
  show(time = 0.5) {
    if (document.body.classList.contains("alter")) {
      this.object3D.material.fragmentShader = glslify(
        require("../../../shaders/particle_alter.frag")
			);
			!document.body.classList.contains('active') ? document.body.classList.add('active') : ''
    } else
      {
        this.object3D.material.fragmentShader = glslify(
        require("../../../shaders/particle.frag")
      );
    }
    // this.object3D.material.fragmentShader = glslify(require('../../../shaders/particle_alter.frag'));
  ...
  destroy(i) {
    ...
    // !document.body.classList.contains("alter") && i%2!==0 && i!==3? document.body.classList.add("alter") : document.body.classList.remove("alter");
  }
