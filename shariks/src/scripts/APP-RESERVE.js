...
export default class App {
  ...
  init() {
    ...
    this.burgerTop = document.querySelector(".burgerLeft").getBoundingClientRect().top;
  ...
  addListeners() {
    ...
    if (screen.width > 850) {
      ...
      window.addEventListener("orientationchange", () => {
        if (document.body.classList.contains("rotated") && !(window.orientation === 90 || window.orientation === -90)) {
      ...
      if (document.body.classList.contains("main")) {
        document.addEventListener("touchmove",e => this.ScrollMobile(e),
          false
        );
  ...
  unrollBurger() {
    if (!this.menu) {
      ...
      document.querySelector(".overlay").classList.contains("rollUp") ? document.querySelector(".overlay").classList.remove("rollUp") : "";
      document.querySelector(".some").classList.contains("rollUp") ? document.querySelector(".some").classList.remove("rollUp") : "";
      ...
      document.querySelector(".overlay").classList.contains("rollDown") ? document.querySelector(".overlay").classList.remove("rollDown") : "";
      document.querySelector(".overlay").classList.add("rollUp");
      document.querySelector(".some").classList.contains("rollDown") ? document.querySelector(".some").classList.remove("rollDown") : "";
